...
/**
 * The aim of WatershedPixel is to enable sorting the pixels of an Image
 * according to their grayscale value.
 *
...
public class WatershedPixel implements Comparable {
	...
	public void addNeighbour(WatershedPixel neighbour) {
		/*
		 * IJ.write("In Pixel, adding :"); IJ.write(""+neighbour); IJ.write(
		 * "Add done");
		 */
	...
	public String toString() {
		return new String(
				"(" + x + "," + y + "), height : " + getIntHeight() + ", label : " + label + ", distance : " + dist);
	}
